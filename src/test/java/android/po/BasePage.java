...
public class BasePage {
    ...
    public MobileElement invalid_new_pass;
    ...
    public void login() throws InterruptedException {
        new WebDriverWait(AppDriver.getDriver(), 5000).until(ExpectedConditions.presenceOfElementLocated(by_permission));

        permission.click();
        new WebDriverWait(AppDriver.getDriver(), 8000).until(ExpectedConditions.presenceOfElementLocated(by_login_button));

        login_button.click();
        new WebDriverWait(AppDriver.getDriver(), 5000).until(ExpectedConditions.presenceOfElementLocated(by_email_field));
        email_field.sendKeys("9140712062");
        password_field.sendKeys("Dbm@12345");
    ...
    public void login_another_id() throws InterruptedException {
        ...
        email_field.sendKeys("9140712062");
        password_field.sendKeys("Dbm@123456");
        continue_button.click();
        Thread.sleep(5000);
