...
public class BasePage {
    ...
    public void login() throws InterruptedException {
        new WebDriverWait(AppDriver.getDriver(), 2000).until(ExpectedConditions.presenceOfElementLocated(by_permission));

        permission.click();
        new WebDriverWait(AppDriver.getDriver(), 2000).until(ExpectedConditions.presenceOfElementLocated(by_login_button));
