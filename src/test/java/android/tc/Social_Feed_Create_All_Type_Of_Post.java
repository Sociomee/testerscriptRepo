...

{
...

   {
...

    {
        ...
        tp.allow_access_photo_media.click();
    ...
    public void Media_post_through_camera() throws InterruptedException
    {
        ...
        tp.select_photo_from_the_list.click();
        ...
        tp.captured_image_through_camera_edit_screen_tick_icon.click();
        tp.select_filter_i_1977.click();
        tp.captured_image_through_camera_filter_screen_next_icon.click();
